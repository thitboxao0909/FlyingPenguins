...
from polls.utils.torch_utils import load_classifier, select_device, time_sync
from polls.utils.plots import Annotator, colors
from polls.utils.general import apply_classifier, check_img_size, check_imshow, check_requirements, check_suffix, colorstr, \
    increment_path, is_ascii, non_max_suppression, print_args, save_one_box, scale_coords, set_logging, \
    strip_optimizer, xyxy2xywh
from polls.utils.datasets import LoadImages, LoadStreams
from polls.models.experimental import attempt_load
import argparse
import sys
...
@torch.no_grad()
def run(weights='../../polls/dete.pt',  # model.pt path(s)
